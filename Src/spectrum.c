...
void SpectrumDisplay_Init(void)
{
    ...
    LCD_DrawString(AMPBOX_X + 8, AMPBOX_Y + 38, 16, "一次谐波", LIGHTGRAY);
    LCD_DrawString(AMPBOX_X + 8, AMPBOX_Y + 60, 16, "二次谐波", LIGHTGRAY);
    LCD_DrawString(AMPBOX_X + 8, AMPBOX_Y + 82, 16, "三次谐波", LIGHTGRAY);
    LCD_DrawString(AMPBOX_X + 8, AMPBOX_Y + 104, 16, "四次谐波", LIGHTGRAY);
    LCD_DrawString(AMPBOX_X + 8, AMPBOX_Y + 126, 16, "五次谐波", LIGHTGRAY);
    LCD_DrawString(AMPBOX_X + 8, AMPBOX_Y + 148, 16, "六次谐波", LIGHTGRAY);
    LCD_DrawString(AMPBOX_X + 8, AMPBOX_Y + 170, 16, "七次谐波", LIGHTGRAY);
    LCD_DrawString(AMPBOX_X + 8, AMPBOX_Y + 192, 16, "八次谐波", LIGHTGRAY);
    LCD_DrawString(AMPBOX_X + 8, AMPBOX_Y + 214, 16, "九次谐波", LIGHTGRAY);
...
void MeasureHarmonics(void)
{
    ...
    LCD_DrawString(BASEFREQBOX_X + 20, BASEFREQBOX_Y + 36, 32, str_buffer, LIGHTGRAY);
